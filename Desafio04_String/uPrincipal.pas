...
{
  Criar uma função de criptografia com as seguintes regras:
- O texto precisa ter 12 ou mais caracteres
- Substituir espaços no texto pelo caracter @
- O texto deve ser quebrado a cada 8 caracteres
- A última linha do texto deve ser completada com o caracter @ até atingir 8 caracteres
...
begin
  ...
  begin
    ShowMessage('Não é permitido inserir menos que 12 caracteres.');
    edtResultado.Clear;
    edtFrase.SetFocus;
  end;
end;
